...
# @export var camera_offset: Vector3 = Vector3(0.0, 8.518, -4.329)
# @export var camera_rotation: Vector3 = Vector3(-375.5, 180, 0)
...
func _physics_process(delta: float) -> void:
	...
	# Linearly interpolate toward the target position for smooth tracking.
